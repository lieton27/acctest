...
Mobile.waitForElementPresent(findTestObject('Homepage/IconPesan'), 0)

Mobile.tap(findTestObject('Homepage/IconPesan'), 0)

Mobile.waitForElementPresent(findTestObject('Daftar/Miscellanous/LinkDaftar'), 0)

Mobile.tap(findTestObject('Daftar/Miscellanous/LinkDaftar'), 0)
...
switch (vResult.toString()) {
    case 'Failed':
        ...
        if (condition.toString() == 'wrongPass') {
        ...
        } else if (condition.toString() == 'username') {
            ...
            Mobile.verifyElementVisible(findTestObject('Daftar/Warnings/WarnUnameEmpty'), 0)
        } else if (condition.toString() == 'fullname') {
            ...
            Mobile.verifyElementVisible(findTestObject('Daftar/Warnings/WarnFNameEmpty'), 0)
        } else if (condition.toString() == 'email') {
        ...
        } else if (condition.toString() == 'password') {
            ...
            Mobile.verifyElementVisible(findTestObject('Daftar/Warnings/WarnPassEmpty'), 0)
        } else if (condition.toString() == 'vpassword') {
            ...
            Mobile.verifyElementVisible(findTestObject('Daftar/Warnings/WarnVPassEmpty'), 0)
        } else if (condition.toString() == 'phone') {
